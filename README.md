# 《Node.js 生成式 AI 應用開發實戰：實作 OpenAI API × LangChain × LangGraph × RAG，打造從雲端到本地 LLM 的混合式安全架構》範例程式碼

<a href="https://www.tenlong.com.tw/products/9786264144964">
  <img src="https://cf-assets2.tenlong.com.tw/products/images/000/260/923/original/9786264144964_bc.jpg" height="50%" width="50%" alt="Node.js 生成式 AI 應用開發實戰：實作 OpenAI API × LangChain × LangGraph × RAG，打造從雲端到本地 LLM 的混合式安全架構">
</a>
...
Node.js 開發者駕馭 LLM 的生成式 AI 應用實戰指南<br>
OpenAI API × LangChain × LangGraph × RAG<br>
從零開始打造專屬你的生成式 AI 應用！<br>
...
- [Chapter 03 使用 OpenAI API 建立第一個應用](./ch03/)
- [Chapter 04 運用提示工程打造可控的角色與回應](./ch04/)
- [Chapter 05 調控取樣參數 Temperature 與 Top-P](./ch05/)
- [Chapter 06 使用 Function Calling 讓模型呼叫工具](./ch06/)
...
- [Chapter 13 實作 LangChain 應用案例：AI 部落格寫手](./ch13/)
- [Chapter 14 追蹤與觀測 LangChain 執行流程](./ch14/)
...
- Chapter 18 結合檢索與生成
- [Chapter 19 實作 RAG 應用案例：文件問答助理](./ch21/)
...
- [Chapter 25 透過 MCP 連接第三方工具與資源](./ch25/)
- [Chapter 26 實作 LangGraph 應用案例：可審核與修訂的 AI 寫作 Agent](./ch26/)
- Chapter 27 探索深度代理架構

### Part 05 本地 LLM 部署與安全設計

- Chapter 28 理解本地 LLM 的部署方案
- [Chapter 29 使用 Ollama 管理本地模型](./ch29/)
- [Chapter 30 實作本地 LLM 應用案例：RAG 文件問答助理](./ch30/)
- [Chapter 31 使用 LiteLLM 建構多模型代理服務](./ch31/)
- Chapter 32 強化生成式 AI 應用的資安防護

### Part 06 附錄
- [Appendix A 安裝與設定開發環境](./appendix/)
